...
function CreateEventModal({ open, onClose, onCreated, user }) {
  ...
  /*
   * IMPORTANT:
   * Keep track of whether the modal was previously open.
   *
   * This prevents the form from being reset during a normal
   * re-render, including when an image is selected.
   */
  const wasOpenRef = React.useRef(false);

  /*
   * Reset the form ONLY when the modal transitions from
   * closed -> open.
   */
  useEffect(() => {
  ...
  /*
   * Image preview is completely independent from the rest
   * of the form state.
   *
   * Selecting an image therefore cannot reset any other field.
   */
  useEffect(() => {
    if (!imageFile) {
      setImagePreview("");
  ...
  const handleImageChange = (event) => {
    ...
    /*
     * Only change image state.
     *
     * DO NOT reset any other form fields here.
     */
    setImageFile(file);
  };
    ...
    try {
      ...
      if (shiftBasedRegistration) {
        for (let index = 0; index < shifts.length; index += 1) {
          ...
          if (!shift.label?.trim()) {
            throw new Error(`Shift ${index + 1} needs a label.`);
          }

          if (!shift.startAt || !shift.endAt) {
            throw new Error(
              `Shift ${index + 1} needs both a start and end time.`
            );
          }
          ...
          if (
            ...
            throw new Error(
              `Shift ${index + 1} has an invalid date or time.`
            );
          }

          if (shiftEnd <= shiftStart) {
            throw new Error(
              `Shift ${index + 1} must end after it starts.`
            );
          }
        }
      }
      ...
      if (recurrenceFrequency !== "none" && !recurrenceEndDate) {
        throw new Error(
          "Please choose a date through which the event should repeat."
        );
      }
      ...
      formData.append(
        ...
        JSON.stringify({
          ...
          defaultRatePerHour: Number(defaultRate) || 0,
          overrideTotalPoints:
            overridePoints === ""
              ? ""
        ...
        JSON.stringify(
          shifts.map((shift) => ({
            ...
            startAt: shift.startAt
              ? new Date(shift.startAt).toISOString()
              : "",
            endAt: shift.endAt
              ? new Date(shift.endAt).toISOString()
              : "",
            capacityMax:
              shift.capacityMax === ""
                ? ""
                : Number(shift.capacityMax),
          }))
        )
      );
          ...
          >
            <div className="events-modal-header">
              <div>
                ...
                <p>
                  Set visibility, add attachments, define shifts,
                  and optionally generate recurring instances.
                </p>

                <p className="events-required-note">
            ...
            >
              <div className="events-form-grid events-form-grid-featured">
                <label className="events-field events-field-wide">
                  <span>
                    Event title{" "}
                    <strong
                      className="events-required-asterisk"
                      aria-hidden="true"
                    >
                      *
                    </strong>
                  ...
                  <input
                    ...
                    required
                    placeholder="Spring Recruitment Info Session"
                  />
                </label>
                ...
                <label className="events-field">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setPointsCategory(e.target.value)
                    }
                  >
              ...
              <label className="events-field">
                ...
                <textarea
                  ...
                  rows={4}
                  placeholder="Add a short event summary, RSVP expectations, and any notes attendees should know."
                />
              </label>
              ...
              <div className="events-form-grid">
                <label className="events-field">
                  ...
                  <input
                    ...
                    placeholder="Engineering Building, Room 205"
                  />
                </label>
              ...
              <div className="events-form-grid">
                ...
                <label className="events-field">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setOverridePoints(e.target.value)
                    }
              ...
              <div className="events-toggle-panel">
                <div>
                  ...
                  <p>
                    Use the mandatory option for events where
                    absence should stand out to members.
                  </p>
                </div>
              ...
              <div className="events-toggle-panel">
                <div>
                  ...
                  <p>
                    Turn this on when members must RSVP to a
                    specific time slot.
                  </p>
                </div>
                ...
                <div className="events-segmented-control">
                  ...
                  <button
                    ...
                    onClick={() =>
                      setShiftBasedRegistration(true)
                    }
                  >
                    Shift-Based
                  </button>
              ...
              <div className="events-toggle-panel">
                <div>
                  ...
                  <p>
                    Create daily, weekly, bi-weekly, or monthly
                    follow-up instances through a chosen end date.
                  </p>
                </div>
              ...
              <div className="events-upload-panel">
                <div className="events-upload-copy">
                  ...
                  <p>
                    Upload a photo for the event card. If you
                    skip this, the page falls back to a branded
                    placeholder.
                  </p>
                </div>
              ...
              <div className="events-upload-panel">
                <div className="events-upload-copy">
                  ...
                  <p>
                    Attach PDFs, docs, slides, or flyers.
                    Members can download them from the event
                    card.
                  </p>
                </div>
                ...
                <div className="events-attachment-list">
                  {attachmentFiles.map((file) => (
                    <div
                      ...
                      className="events-attachment-item"
                    >
              ...
              <div className="events-visibility-panel">
                <div>
                  ...
                  <p>
                    Choose which member groups should see this
                    event.
                  </p>
                </div>
              ...
              <div className="events-visibility-panel">
                <div>
                  ...
                  <p>
                    Optional restriction for specific membership
                    states.
                  </p>
                </div>
                ...
                <div className="events-chip-row">
                  {MEMBER_STATUS_OPTIONS.map((status) => (
                    <button
                      ...
                      key={status}
                      className={
                        memberStatusesAllowed.includes(status)
                          ? "events-chip active"
                          : "events-chip"
                      }
                      onClick={() =>
                        toggleMemberStatus(status)
                      }
                    >
                      {status}
                    </button>
              ...
              {error ? (
                <div className="events-form-error">
                  {error}
                </div>
              ) : null}
